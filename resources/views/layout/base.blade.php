  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('/blog') }}" class="nav-link active">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('/blog/tentang') }}" class="nav-link active">Tentang</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('/blog/kontak') }}" class="nav-link">Kontak</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('/blog/dashboard') }}" class="nav-link">Dashboard</a>
      </li>
    </ul>
